...
function pageButtons(pages){
  ...
  wrapper.innerHTML=`<button value=${-1} class="move btn btn-sm btn-dark px-3 mx-2">&#171; Previous</button>`+
  wrapper.innerHTML;
  if(state.page !== 1){
    wrapper.innerHTML=`<button value=${1} class="page btn btn-sm btn-warning px-3 mx-2">&#171; First</button>`+
    wrapper.innerHTML;
  }
